...
const Tickets = () => {
  ...
  // Calculate in-progress count from taskStatus only (starts at 0)
  const inProgressCount = taskStatus.filter(
        ...
        <div className="md:w-3/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tickets.map((ticket) => (
              ...
              >
                <div
                  className={`absolute top-4 right-4 px-3 py-1 text-xs font-semibold rounded-full flex items-center justify-center
                    ${
                      ticket.status === "open"
